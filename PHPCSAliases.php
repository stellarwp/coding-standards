 ...
 *
 * @package Tribe\TribalScents
 * @link    https://github.com/moderntribe/TribalScents
 ...
 * manner.}}
 */
if ( ! \defined( 'TRIBALSCENTS_PHPCS_ALIASES_SET' ) ) {
	...
	define( 'TRIBALSCENTS_PHPCS_ALIASES_SET', true );

	/*
	 * Register our own autoloader for the TribalScents abstract classes & the helper class.
	 *
